...
Plotly.d3.csv(csvUrl, function (err, rows) {
    ...
    var pop_start = unpack(rows, "percent_homeless_2016");
    var states = unpack(rows, "State");
    var pop_end = unpack(rows, "homeless_pop_2016");
    ...
    for (var i = 0; i < states.length; i += 1) {
        ...
        annotations.push(`${pop_end[i]} Homeless People`);
        codes.push(code);
    }
